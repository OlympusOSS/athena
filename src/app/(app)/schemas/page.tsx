					...
					<Card>
						<CardContent>
							...
							<p className="text-sm text-muted-foreground">
								Identity schemas define the structure of identity data in the identity service. They determine what fields are available for
								registration, login, and profile management. Use schemas to customize the user experience and data collection for your application.
							</p>
						</CardContent>
					</Card>
