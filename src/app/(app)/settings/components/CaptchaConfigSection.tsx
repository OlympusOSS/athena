...
import { Alert, AlertDescription, Card, CardContent, CardHeader, CardTitle, cn, Icon, Input, Label, Switch } from "@olympusoss/canvas";
			...
			<Card>
				...
				<CardContent className="pt-0 space-y-4">
					...
					<div className="space-y-1.5">
						<Label htmlFor="captcha-site-key" className="text-xs">
							Site Key
						</Label>
					...
					<div className="space-y-1.5">
						<Label htmlFor="captcha-secret-key" className="text-xs">
							Secret Key
						</Label>
						<div className="relative">
